			...
			if( AstraSitesAdmin.visited_sites_and_pages[ site_id ] ) {
				...
				.done(function ( response ) {
					...
					if( response.success ) {
						...
						AstraSitesAdmin.process_site_data( AstraSitesAdmin.templateData );
						if ( response.data['astra-site-type'] === 'premium' ) {
							var jsonUrl = astraSitesVars.siteURL + "/wp-content/plugins/astra-pro-sites/astra-sites/" + site_id + ".json"
							$.getJSON( jsonUrl, function( data ) {
								AstraSitesAdmin.process_site_data( data );
							});
						}
					} else {
