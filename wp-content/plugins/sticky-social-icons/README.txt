...
1. Sticky Social Icons showing in the left side of the website.
2. Sticky Social Icons showing in the right side of the website.
3. Plugin's settings page inside wordpress admin panel.
4. Icons selection tab inside plugin's settings page.
5. User can customize the URL, tooltip label, colors and other features that are visible in the front-end of the website.
